...
*/ if (amysBirthYear === brittanisBirthYear){
  ...
  console.log("amy and brittaney were not born in the same year")
}
...
if (temperature >= 80 && rain === true) {
  console.log("one should wear a t-shirt and take an humbrella.")
} else if (temperature >= 60 || temperature <= 80 && rain === true) {
  console.log("one should wear a rain jacket.")
} if (temperature <= 60 && rain === false) {
  console.log("one should wear a jacket and carry an humbrella")
} if (rain === false) {
